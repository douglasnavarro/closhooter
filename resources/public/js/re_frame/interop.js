...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__21410 = cljs.core.instance_QMARK_;
var expr__21411 = reactive_val;
if(cljs.core.truth_(pred__21410.call(null,reagent.ratom.RAtom,expr__21411))){
return "ra";
} else {
if(cljs.core.truth_(pred__21410.call(null,reagent.ratom.RCursor,expr__21411))){
return "rc";
} else {
if(cljs.core.truth_(pred__21410.call(null,reagent.ratom.Reaction,expr__21411))){
return "rx";
} else {
if(cljs.core.truth_(pred__21410.call(null,reagent.ratom.Track,expr__21411))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1563744770410
